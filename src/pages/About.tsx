...
const About = () => {
    ...
    return (
        <div className="flex justify-center max-w-3xl mx-auto gap-10">
            <div className="bg-white rounded-2xl shadow-[0_2px_8px_var(--color-shadow)] p-10 max-w-3xl w-full border" style={{ borderColor: 'var(--color-main-light-alpha)' }}>
                <div>
                    ...
                    <ul className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        <li>
                            <a
                                ...
                                className="flex items-center gap-2 bg-[var(--color-bg-box)] rounded-xl px-3 py-2 shadow-sm border border-[var(--color-main-light-alpha)] transition-transform duration-200 hover:scale-[1.03] hover:bg-[var(--color-bg-hover)] active:scale-100"
